...
//this.order._updateRewards();
    ...
    get_discount_amount_str() {
        return round_di(this.discount_amount || 0, 2).toFixed(2)
    },
    ...
    get_discount_amount() {
        ...
        this.discount_amount = parseFloat(
            round_di(discount_amount || 0, 2).toFixed(2)
        )
        return this.discount_amount;
    },

    get_gdiscount_amount_str() {
        return round_di(this.gdiscount_amount || 0, 2).toFixed(2)
    },
    ...
    get_gdiscount_amount() {
        ...
        this.gdiscount_amount = parseFloat(
            round_di(gdiscount_amount || 0, 2).toFixed(2)
        )
