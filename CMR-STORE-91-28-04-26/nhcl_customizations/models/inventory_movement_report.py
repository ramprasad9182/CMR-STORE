...
class InventoryMovementReport(models.Model):
    ...
    hpi_qty = fields.Float(string="Hired Inward Qty", readonly=True)
    hpi_rs_total = fields.Float(string="Hired Inward Value", readonly=True)
    hpo_qty = fields.Float(string="Hired Outward Qty", readonly=True)
    hpo_rs_total = fields.Float(string="Hired Outward Value", readonly=True)
