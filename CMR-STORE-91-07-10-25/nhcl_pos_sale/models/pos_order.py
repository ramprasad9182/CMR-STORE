    ...
    def create(self, vals):
        ...
        for reward_order_line in reward_order_lines:
            if reward_order_line.reward_id.program_id.is_vendor_return == True:
                if reward_order_line.reward_id.reward_type == 'product' and reward_order_line.reward_id.program_id.rule_ids.ref_product_ids.id == reward_order_line.reward_id.reward_product_id.id:
