...
//      }
//})
           for (let i = 0; i < highestDiscountRewards.length; i++) {
...
//            console.log("[auto_apply_rewards] Applying reward:", reward, "coupon_id:", coupon_id, "potentialQty:", potentialQty);
...
//        console.log("[auto_apply_rewards] Order after applying rewards:", order.get_orderlines());
