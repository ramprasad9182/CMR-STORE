...
class Picking(models.Model):
    ...
    def button_validate(self):
        ...
        for rec in self:
            ...
            if rec.stock_picking_type == 'return' and rec.picking_type_code == 'outgoing':
                if not all([
                    rec.transpoter_id,
                    ...
                    for move_line in self.move_line_ids_without_package.filtered(
                        ...
                        if (not move_line.lot_name
                            ...
                            move_line.update({
                                ...
                                'categ_1': dummy.categ_1 or False,
                                'categ_2': dummy.categ_2 or False,
                                'categ_3': dummy.categ_3 or False,
                                'categ_4': dummy.categ_4 or False,
                                'categ_5': dummy.categ_5 or False,
                                'categ_6': dummy.categ_6 or False,
                                'categ_7': dummy.categ_7 or False,
                                'categ_8': dummy.categ_8 or False,
                                'descrip_1': dummy.descrip_1 or False,
                                'descrip_2': dummy.descrip_2 or False,
                                'descrip_3': dummy.descrip_3 or False,
                                'descrip_4': dummy.descrip_4 or False,
                                'descrip_5': dummy.descrip_5 or False,
                                'descrip_6': dummy.descrip_6 or False,
                            })
        ...
        if self.verify_barcode:
            ...
            if re.match(gs1_pattern, barcode):
                ...
                if tracking_type == 'serial':
                    ...
                    if matched_line.stock_actual_qty == self.receipt_lot_qty:
                        matched_line.stock_status = 'matched'
