    ...
    def create(self, vals):
        ...
        for reward_order_line in reward_order_lines:
            if reward_order_line.reward_id.program_id.is_vendor_return == True:
                if reward_order_line.reward_id.discount_applicability == 'order':
                ...
                elif reward_order_line.reward_id.reward_type == 'product' and reward_order_line.rule_id.ref_product_ids.id == reward_order_line.reward_id.reward_product_id.id:
                    for remaining_order_line in remaining_order_lines:
                        if reward_order_lines.product_id == remaining_order_line.product_id:
                            for remain in remaining_order_lines:
                                remain.vendor_return_disc_price = remain.price_unit
                else:
