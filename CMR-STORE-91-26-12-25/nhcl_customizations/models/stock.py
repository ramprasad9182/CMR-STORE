...
class Picking(models.Model):
    ...
    #     if defaults and defaults['stock_picking_type']:
    #         defaults['picking_type_id'] = self.env['stock.picking.type'].search(
    #             [('stock_picking_type', '=', defaults['stock_picking_type'])]).id
    #     return defaults
