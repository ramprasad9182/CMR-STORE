...
class Picking(models.Model):
    ...
    stock_type = fields.Selection(
        [('advertisement', 'Advertisement'), ('ho_operation', 'HO Operation'), ('data_import','Data Import'),('inter_state', 'Inter State'),
    ...
    #     for rec in self:
    #         lines = rec.nhcl_pos_order.lines
    #         if lines and all(line.is_pos_order_used_line for line in
    #                          lines.filtered(lambda x: x.product_id.nhcl_detailed_type == 'product')):
    #             raise ValidationError(_("All products are Exchanged..."))
            ...
            if rec.store_pos_order != False:
                ...
                if pos.get("data"):
                    ...
                    for line_data in pos.get("data")[0]["lines"]:
                        ...
                        pos_line_data_domain = [('id', '=', line_data['id']), ('order_id', '=', pos_order_id), ('is_pos_order_used_line', '=', False)]
    ...
    def button_validate(self):
        ...
        for rec in self:
            ...
            if rec.stock_picking_type == 'receipt' and rec.picking_type_code == 'incoming' and rec.stock_type != 'data_import':
                ...
                if total_grc_qty > actual_qty:
                    rec.nhcl_shortage_qty = diff_qty
                for stock_move_id in rec.move_ids:
                    ...
                    # stock_move_id.move_line_ids.quantity = sum(self.stock_verification_ids.filtered(
                    #     lambda x: x.stock_product_id == stock_move_id.product_id and stock_move_id.product_id.tracking == 'lot').mapped('stock_actual_qty'))
    ...
    def update_same_store_flag(self):
        for pick in self:
            ...
            matched_lines = pos_order.lines.filtered(lambda l: l.pack_lot_ids and l.pack_lot_ids.lot_name in move_serials)
            matched_lines.write({
    ...
    def _onchange_stock_barcode(self):
        ...
        gs1_pattern = r'01(\d{14})21([A-Za-z0-9]+)'
        ean13_pattern = r'(\d{13})'
        custom_serial_pattern = r'^([A-Za-z][A-Za-z0-9]*)$'
...
class PickingType(models.Model):
    ...
    stock_picking_type = fields.Selection([('exchange', 'Customer-Return'), ('receipt', 'Receipt')
                                           ...
                                           ('hpo', 'Hired Product Outward'), ('hpi', 'Hired Product Inward')], string='Type', tracking=True)
...
class StockMove(models.Model):
    ...
    def change_exchange_move_qty(self):
        for rec in self:
            if rec.nhcl_move_qty and (rec.nhcl_move_qty > rec.quantity):
    ...
    def _compute_amount(self):
        for line in self:
            ...
            print(amount_untaxed,amount_tax,"amountttttt")
            line.update({
    ...
    def action_assign_serial(self):
        if self.picking_id.picking_type_id.code == 'incoming' and self.picking_id.stock_type in ['ho_operation','data_import']:
            raise ValidationError(
...
class StockBackorderConfirmation(models.TransientModel):
    ...
    def process(self):
        ...
        for pick_id in self.pick_ids:
            ...
            elif pick_id.picking_type_id.code == 'incoming' and pick_id.stock_type in ['data_import'] and pick_id.is_confirm == False:
    ...
    def process_cancel_backorder(self):
        for pick_id in self.pick_ids:
            if pick_id.picking_type_id.code == 'incoming' and pick_id.stock_type in ['data_import'] and pick_id.is_confirm == False:
                pick_id.move_ids.auto_generate_serial_numbers()
                pick_id.is_confirm = True
