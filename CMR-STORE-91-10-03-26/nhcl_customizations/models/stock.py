...
class Picking(models.Model):
    ...
    transfer_type = fields.Selection(
        [('regular', 'Regular'), ('damage', 'Damage'), ('stock_mismatch', 'Stock Mismatch'), ('hired', 'Hired Product')],
    ...
    def check_nhcl_pos_order(self):
        for rec in self:
            ...
            if lines and all(line.is_pos_order_used_line for line in lines.filtered(lambda x:x.product_id.nhcl_detailed_type == 'product')):
